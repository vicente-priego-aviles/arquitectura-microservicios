...
| Límite de concurrencia | Concurrency Limit | Acota cuántas invocaciones de un método pueden estar en curso a la vez; variante del patrón clásico Bulkhead (mamparo/compartimento estanco), sin traducción española de uso consolidado |
